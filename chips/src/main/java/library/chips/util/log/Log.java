...
//    private static final LogWrapper log = BuildConfig.isLogEnabled ? new AndroidLog() : new SilentLog();
    private static final LogWrapper log = new SilentLog();
    ...
    public static class LogSwitcher {
        private final Set<Integer> enabledLogs = new HashSet<>();
